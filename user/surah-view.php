    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title" style="margin-top:4%">Surah Ringkas</h2>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php
                                            $ret = "SELECT * FROM Surah ORDER BY S_RegDate ASC";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    if (!empty($row->S_Audio)) {
                                                        ?>
                                                        <audio controls>
                                                            <source src="../admin/<?php echo $row->S_Audio;?>" type="audio/mpeg">
                                                ...
                                                <td>
                                                    ...
                                                    if (!empty($row->S_File)) {
                                                        ...
                                                        ?>
                                                        <a href="../admin/<?php echo $file_path;?>" target="_blank">Surah <?php echo $row->S_Name;?></a>
                                                    <?php } else {
