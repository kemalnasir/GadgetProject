...
if(isset($_POST['resetpass']))
{
	...
	$sql="SELECT S_IC FROM STAFF where S_IC=?";
	...
	if($row_cnt>0)
	{
		$con="UPDATE STAFF SET S_Password=? where S_IC=?";
		...
		header('Refresh:0.1; url=staff-login.php');
	}
	else
	{
...
<?php include('includes/headermain.php');?>
	<div class="login-page bk-img" style="background-image: urlurl(img/24.jpg);">
