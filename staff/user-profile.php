                                        ...
                                        <div class="panel-body">
                                            <form method="post" class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" value="<?php echo $row->U_IC; ?>" disabled class="form-control"><span class="help-block m-b-none">IC can't be changed.</span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Name</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" value="<?php echo $row->U_FName . ' ' . $row->U_LName; ?>" disabled class="form-control"><span class="help-block m-b-none">Name can't be changed.</span>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" value="<?php echo $row->U_Gender; ?>" disabled class="form-control"><span class="help-block m-b-none">Gender can't be changed.</span>
                                                    </div>
                                                </div>
