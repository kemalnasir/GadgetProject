...
if (isset($_POST['update'])) {
    ...
    $stmt->close();
    if ($count > 0) {
        echo "<script>alert('E-mel sudah wujud. Sila gunakan e-mel lain.');</script>";
    } else {
        // Kemaskini e-mel
        ...
        $stmt->execute();
        echo "<script>alert('E-mel telah berjaya dikemaskini!');</script>";
    }
...
if (isset($_POST['changepwd'])) {
    ...
    if ($row_cnt > 0) {
        ...
        $_SESSION['msg'] = "Kata laluan lama tidak sepadan.";
    }
}
?>
<!doctype html>
    ...
    <script type="text/javascript">
        function valid() {
            if (document.changepwd.newpassword.value != document.changepwd.cpassword.value) {
                alert("Kata Laluan Baru dan Sahkan Kata Laluan tidak sepadan!");
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                    <br>
                        <h2 class="page-title">Butiran Profil</h2>
                        <?php
                        $aid = $_SESSION['id'];
                                        ...
                                        <div class="panel-body">
                                            <form method="post" class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" value="<?php echo $row->U_IC; ?>" disabled class="form-control"><span class="help-block m-b-none">IC tidak boleh diubah.</span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" value="<?php echo $row->U_Roles; ?>" disabled class="form-control"><span class="help-block m-b-none"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">E-mel</label>
                                                    <div class="col-sm-10">
...
// Apabila pengguna klik pada medan kata laluan, kotak mesej akan dipaparkan
myInput.onfocus = function() {
  document.getElementById("message").style.display = "block";
}

// Apabila pengguna klik di luar medan kata laluan, kotak mesej akan disembunyikan
myInput.onblur = function() {
  document.getElementById("message").style.display = "none";
}

// Apabila pengguna mula menaip sesuatu di dalam medan kata laluan
